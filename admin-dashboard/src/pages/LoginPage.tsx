      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-auto text-center">
            <h1 className="text-3xl font-bold text-gray-900">🏡 Domy v Italii</h1>
          </div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Přihlášení pro zaměstnance
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Přihlaste se ke svému admin účtu
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 text-gray-500">Demo přihlašovací údaje</span>
              </div>
            </div>
